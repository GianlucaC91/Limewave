    ...
    <div class="container-fluid w-100">
        <div class="row w-100 m-0">
            ...
            <div class="collapse navbar-collapse d-flex">
                <div class="ms-auto">
                    <a class="nav-link dropdown-toggle text-p" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        @auth
                    ...
                    <ul class="dropdown-menu bg-s">
                        @guest
                        <li>
                            <a class="dropdown-item text-p" href="{{ route('login') }}">Accedi</a>
                        </li>
                        <li>
                            <a class="dropdown-item text-p" href="{{ route('register') }}">Registrati</a>
                        </li>
                        @endguest
                        @auth
                        <li>
